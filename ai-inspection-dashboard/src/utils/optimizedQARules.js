...
// 实际供应商列表 (基于material_supplier_mapping.js)
export const ACTUAL_SUPPLIERS = [
  // 结构件供应商
  '歌尔股份', '蓝思科技', '比亚迪电子', '领益智造', '通达集团', '安洁科技',
  '安捷利美维', '立讯精密', '信邦', '赛尔康', '欧菲光', '柏承电子',
  
  // 光学供应商
  'BOE', '天马', '华星', '京东方', '维信诺', '和辉光电',
  '舜宇光学', '欧菲光', '丘钛科技', '信利光电',
  
  // 电子供应商
  '德赛电池', '欣旺达', '比亚迪', '宁德时代', '立讯精密', '意丰科技',
...
export const ACTUAL_MATERIALS = [
  // 结构件类
  '手机壳料-后盖', '手机壳料-中框', '手机卡托', '侧键', '装饰件',
  
  // 光学类
  'LCD显示屏', 'OLED显示屏', '摄像头模组', '镜头组件',
