      ...
      <div class="input-container">
        ...
        <div class="input-hints">
          <div class="hints-left">
            ...
            <!-- 模型选择器 -->
            <el-select v-model="selectedModel" size="small" class="model-selector">
...
export default {
  ...
  setup(props) {
    ...
    const selectedModel = ref(aiConfig.models.chat);
